...
- [Typecasting ou conversão de tipos](#typecasting) 
...
- [Exercicios](#exerVar)
- [Operadores aritimédicos](#oAritimedicos) 
...
- [Estrutura de Condição](#condicao) 
    -[if/else](#ifelse) 
...
- [Estrutura de repetição](#estruturaDeRepeticao) 
    -[O while](#while) 
